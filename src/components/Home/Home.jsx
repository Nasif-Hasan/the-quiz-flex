                ...
                <div className="p-8 sm:p-16">
                    ...
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <a href="/statistics" rel="noreferrer noopener" className="px-5 mt-4 lg:mt-0 py-3 rounded-md border block font-bold dark:bg-red-50 hover:bg-red-500 hover:text-white dark:text-gray-900 dark:border-none">Show Statics</a>
                        </div>
                    </div>
